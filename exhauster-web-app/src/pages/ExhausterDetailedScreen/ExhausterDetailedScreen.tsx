...
export namespace ExhausterDetailedScreen {
  ...
  export const ExhausterDetailedScreen = memo(function ExhausterDetailedScreen() {
    ...
    if (!['scheme', 'chart'].includes((screen as any))) return <Navigate to={`/exhauster-detailed/${exhausterId}/scheme`} replace={true} />;
    return <Page>
      <Space h={16} />
      <TileSelectFrame>
      ...
      <PageElement>
        <Card>
          ...
          <Routes>
            <Route path={'scheme'} element={<ExhausterDetailedViewFrame elements={exhauster.allElements} updateTime={updateTime} />} />
  ...
  function ExhausterDetailedViewFrame({
    elements,
    updateTime
