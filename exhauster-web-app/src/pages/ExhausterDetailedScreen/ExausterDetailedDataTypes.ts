...
export namespace ExausterDetailedDataTypes {
  ...
  export type LocationType = 'bearer-1' | 'bearer-2' | 'bearer-3' | 'bearer-4' | 'bearer-5' | 'bearer-6' | 'bearer-7' | 'bearer-8' | 'bearer-9';
  export type MarkType = {
    id: 'temperature' | 'vertical-vibration' | 'horizontal-vibration' | 'axial-vibration' | 'level' | 'pressure' | 'oil-temperature-before' | 'oil-temperature-after' | 'water-temperature-before' | 'water-temperature-after' | 'rotor-current' | 'rotor-voltage' | 'stator-current' | 'stator-voltage' | 'underpressure' | 'dust-level' | 'position';
    value: number;
    state: StateType;
  ...
  export type ElementType = BearerElementType | OilElementType | RotorElementType | CoolerElementType | MainEngineElementType | GasCollectorElementType | ValveElementType;
