...
function ExhausterCard(props: ExhausterCardProps) {
  ...
  return <Exhauster>
    ...
    <MainContentFrame>
      <Space h={10} />
      <RotorTitle.RotorTitle name={props.exhauster.rotor.name} replacementDate={props.exhauster.rotor.replacementDate} />
      <Space h={15} />
      <Line />
      <Space h={15} />
      <RotorReplacement.RotorReplacement daysPassed={props.exhauster.rotor.replacementWere} daysLeft={props.exhauster.rotor.replacementForecast} state={props.exhauster.rotor.replacementForecastState} />
      <Space h={15} />
      ...
      <DropDownList.DropDownList title='Предупреждения' items={[...props.exhauster.bearers, props.exhauster.oil].filter(it => ['caution', 'danger'].includes(it['state']))} setSelectedBearers={setSelectedBearers} />
      
      <Space h={10} />
      
      <DropDownList.DropDownList title='Исправные элементы' items={[...props.exhauster.bearers, props.exhauster.oil].filter(it => !['caution', 'danger'].includes(it['state']))} setSelectedBearers={setSelectedBearers} />
